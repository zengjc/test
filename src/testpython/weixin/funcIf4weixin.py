...
class eventHandler:
    MSG_WELCOME = '欢迎您关注我，想了解我，就请发送“帮助”或“？”'
...
class txtmsgHandler:
    MSG_HELP = '''我会记录您对我说的除“查询”和“帮助”以外的所有的话，“查询”会得到您最后一次对我说的话
'''
    MSG_SUCCESS = ['存储完成', '我存好了，随时来查哦','搞定，收工']
